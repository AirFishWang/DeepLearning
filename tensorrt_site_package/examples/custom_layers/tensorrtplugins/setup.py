...
TENSORRT_INC_DIR = os.environ.get("TENSORRT_INC_DIR", '/home/wangchun/TensorRT-4.0.1.6-CUDA9.0/include')
TENSORRT_LIB_DIR = os.environ.get("TENSORRT_LIB_DIR", '/home/wangchun/TensorRT-4.0.1.6-CUDA9.0/lib')
