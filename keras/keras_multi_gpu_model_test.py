...
with tf.device('/cpu:0'):
    model = Xception(weights=None,
                     ...
                     classes=num_classes)
    # print "optimizer = {}".format(model.optimizer)             # 'Model' object has no attribute 'optimizer'
...
print "optimizer = {}".format(hasattr(parallel_model, 'optimizer'))
print parallel_model.optimizer.get_config()
